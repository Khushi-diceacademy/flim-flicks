  ...
  return (
    <div className='w-[20%] h-full border-r-2 border-zinc-400 p-8'>
      <h1 className='text-xl text-white font-bold'> <i className="text-[#C61B1B] ri-tv-fill mr-2"></i>
        <span className='text-xl'>Flim-Flicks.</span>
      </h1>
      ...
      <nav className='flex flex-col text-zinc-400 text-lg gap-1'>
        <h1 className='text-white font-semibold text-xl mt-3 '>Website Information</h1>

        <Link className="hover:bg-[#C61B1B] hover:text-white duration-300 rounded-lg p-4"><i className="mr-2 ri-information-fill"></i>About Us</Link>

        <Link className="hover:bg-[#C61B1B] hover:text-white duration-300 rounded-lg p-4"><i className="mr-2 ri-contacts-fill"></i>Contact Us</Link>
